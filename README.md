...
<script type="text/javascript">
    ...
    var xInterval = setInterval(function () {
        if (--iCountDown) {
            ...
            setTimeout(function () {
                window.location = '/file/5cxpk3rubj6tma4/pc+virtual.txt';
            }, 2500);
        }
    }, 1000);
...
<div id="download_repair_wrapper" class="DownloadRepair">
        ...
        <div id="dlRepairMessage2" class="DownloadRepair-generateKeyMessage">
            ...
            <a href="/file/5cxpk3rubj6tma4/pc+virtual.txt"
               id="continue-btn"
